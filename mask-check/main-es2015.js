...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"map-container\" leaflet (leafletMapReady)=\"onMapReady($event)\" [leafletMarkerCluster]=\"markerCluster\">\r\n</div>\r\n");
...
/* harmony import */ var _asymmetrik_ngx_leaflet_markercluster__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @asymmetrik/ngx-leaflet-markercluster */ "./node_modules/@asymmetrik/ngx-leaflet-markercluster/dist/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _asymmetrik_ngx_leaflet_markercluster__WEBPACK_IMPORTED_MODULE_5__["LeafletMarkerClusterModule"],
...
let MapComponent = class MapComponent {
    ...
    /** 定位使用者位置 */
    initPanToUserPosition({ coords: { latitude, longitude } }) {
        this.map.setZoom(17);
        this.map.panTo(new leaflet__WEBPACK_IMPORTED_MODULE_3__["LatLng"](latitude, longitude));
        const selfMark = new leaflet__WEBPACK_IMPORTED_MODULE_3__["Marker"](new leaflet__WEBPACK_IMPORTED_MODULE_3__["LatLng"](latitude, longitude));
        const selfPopup = new leaflet__WEBPACK_IMPORTED_MODULE_3__["Popup"]({ closeButton: false }).setContent('<div style="text-align: center;">You</div>');
    ...
    loadPhamacyData() {
        this.http.get('https://raw.githubusercontent.com/kiang/pharmacies/master/json/points.json')
            ...
            response.features.forEach(phamacyPoint => {
                ...
                const marker = new leaflet__WEBPACK_IMPORTED_MODULE_3__["Marker"](new leaflet__WEBPACK_IMPORTED_MODULE_3__["LatLng"](latitude, longitude));
                let content = `
          ...
          `;
                ...
                const popup = new leaflet__WEBPACK_IMPORTED_MODULE_3__["Popup"]({ closeButton: false })
                    .setContent(content);
...
module.exports = __webpack_require__(/*! E:\_ng\mask-check\src\main.ts */"./src/main.ts");
